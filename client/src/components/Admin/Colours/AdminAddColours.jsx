...
import zircon from "../../../assets/colors/red.png";
import { Link } from "react-router-dom";

export default function AdminAddColours() {
  const {
    register,
    handleSubmit,
    formState: { errors },
    ...
    <div>
      <div className="flex justify-center min-h-screen mt-10">
        <div className="w-[40rem] items-center bg-slate-50 p-5 rounded-lg shadow-lg">
          <div>
            <h1 className="text-2xl font-bold text-center mb-10">Add Colour</h1>
          </div>
          <form action="">
            {/**Title */}
            <div>
            ...
            <div className="flex justify-center items-center">
              <img src={zircon} alt="" className="w-40 h-50" />
            </div>

            <div className="flex justify-between">
              <div>
                <Link to="/admin?tab=colours">
