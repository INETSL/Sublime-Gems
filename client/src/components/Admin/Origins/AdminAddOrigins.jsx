...
import zircon from "../../../assets/flags/Sri Lanka.png";
import { Link } from "react-router-dom";

export default function AdminAddOrigins() {
  const {
    register,
    handleSubmit,
    formState: { errors },
    ...
    <div>
      <div className="flex justify-center min-h-screen mt-10">
        <div className="w-[40rem] items-center bg-slate-50 p-5 rounded-lg shadow-lg">
          <div>
            <h1 className="text-2xl font-bold text-center mb-10">Add Origin</h1>
          </div>
          <form action="">
            {/**Title */}
            <div>
